            ...
            {this.props.displayName ? null : <Redirect to="/login"/>}
                ...
                <form>
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="child_name" aria-describedby="childName" placeholder={this.state.child_name}/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="journal_entry">Journal Entry</label>
                        <textarea className="form-control" id="journal_entry" rows="6" defaultValue={this.state.journal_entry}></textarea>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <textarea className="form-control" id="behavior_desc" rows="6" defaultValue={this.state.behavior_desc}></textarea>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <textarea className="form-control" id="helpful_desc" rows="6" defaultValue={this.state.helpful_desc}></textarea>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <textarea className="form-control" id="respect_desc" rows="6" defaultValue={this.state.respect_desc}></textarea>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <textarea className="form-control" id="sleep_desc" rows="6" defaultValue={this.state.sleep_desc}></textarea>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <textarea className="form-control" id="regret_desc" rows="6" defaultValue={this.state.regret_desc}></textarea>
                    </div>
